...
if neovimium.default_colorscheme then
  if not pcall(vim.cmd.colorscheme, neovimium.default_colorscheme) then
    require("neovimium.utils").notify("Error setting up colorscheme: " .. neovimium.default_colorscheme, "error")
  end
end

require("neovimium.utils").conditional_func(neovimium.user_opts("polish", nil, false), true)
